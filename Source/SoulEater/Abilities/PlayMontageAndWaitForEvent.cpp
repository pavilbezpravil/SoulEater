...
USEAbilitySystemComponent* UPlayMontageAndWaitForEvent::GetTargetASC()
{
	return Cast<USEAbilitySystemComponent>(AbilitySystemComponent);
}
...
void UPlayMontageAndWaitForEvent::Activate()
{
	...
	USEAbilitySystemComponent* RPGAbilitySystemComponent = GetTargetASC();
